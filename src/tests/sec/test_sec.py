...
# fake_download_manager = mock.MagicMock(DownloadManager)


# @mock.patch("stocktracer.collector.sec.download_manager", fake_download_manager)
# class TestSec:
...
#         type(fake_download_manager).ticker_reader = mock.PropertyMock(
...
#             orient="index",
#         )
#         fake_download_manager.get_quarterly_report = mock.MagicMock(
#             return_value=data_reader
#         )
...
#         fake_download_manager.get_quarterly_report.assert_called()
